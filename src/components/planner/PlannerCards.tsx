      ...
      {items.map((item) => {
        ...
        return (
          <article
            ...
            className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm space-y-3 cursor-pointer active:scale-[0.99] transition-transform"
          >
            ...
            {/* Hook Snippet */}
            {item.hook && (
              <div className="bg-slate-50 rounded-lg p-2.5 text-xs text-slate-600 border border-slate-100 flex items-start justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-1.5 text-xs">
              {item.format && (
                <span className="px-2 py-0.5 rounded bg-purple-50 text-purple-700 font-medium text-[11px] border border-purple-100">
            ...
            <div className="pt-2 border-t border-slate-100 space-y-2">
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-1.5 text-slate-600">
                  <IconClock className="w-3.5 h-3.5 text-slate-400" size={14} />
                  {formattedSchedule ? (
                ...
                {isToday && (
                  <span className="inline-flex items-center text-[10px] font-bold text-purple-700 bg-purple-100 px-1.5 py-0.2 rounded">
                    {t('common.today')}
                  </span>
                )}
              </div>
